...
public class EthMnemonic {
    ...
    public static void main(String[] args) {
        ...
        // 导入助记词
        // [team, bid, property, oval, hedgehog, observe, badge, cabin, color, cruel,
        // casino, blame]
    ...
    private static EthHDWallet createEthWallet(DeterministicSeed ds, String[] pathArray, String password) {
        ...
        try {
            ...
            System.out.println("验证助记词种子 " + Arrays.toString(checkMnemonicSeedBytes));
        ...
        try {
            ...
            ethHDWallet = new EthHDWallet(keyPair.getPrivateKey().toString(16), keyPair.getPublicKey().toString(16),
                    mnemonic, dkKey.getPathAsString(), "0x" + walletFile.getAddress(), jsonStr);
    ...
    public static class EthHDWallet {
        ...
        public EthHDWallet(String privateKey, String publicKey, List<String> mnemonic, String mnemonicPath,
