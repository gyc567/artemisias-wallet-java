...
public class Kit {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // - TestNet3Params
        // - RegTestParams
        // While developing your application you probably want to use the Regtest mode
        // and run your local bitcoin network. Run bitcoind with the -regtest flag
        // To test you app with a real network you can use the testnet. The testnet is
        // an alternative bitcoin network that follows the same rules as main network.
        // Coins are worth nothing and you can get coins for example from
        // http://faucet.xeno-genesis.com/
        //
        // For more information have a look at: https://bitcoinj.github.io/testing and
        // https://bitcoin.org/en/developer-examples#testing-applications
        NetworkParameters params = TestNet3Params.get();
        System.out.println("test in TestNet: " + params);
        // Now we initialize a new WalletAppKit. The kit handles all the boilerplate for
        // us and is the easiest way to get everything up and running.
        // Have a look at the WalletAppKit documentation and its source to understand
        ...
        // In case you want to connect with your local bitcoind tell the kit to connect
        // to localhost.
        // You must do that in reg test mode.
        // kit.connectToLocalHost();

        // Now we start the kit and sync the blockchain.
        // bitcoinj is working a lot with the Google Guava libraries. The WalletAppKit
        // extends the AbstractIdleService. Have a look at the introduction to Guava
        // services: https://github.com/google/guava/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();
        ...
        System.out.println("1-----10 000 satoshi=	0.00010000 ฿ You have " + (kit.wallet().getBalance()) + "satoshi");
        // Ready to run. The kit syncs the blockchain and our wallet event listener gets
        ...
        // want to stop the kit. The WalletAppKit registers a runtime ShutdownHook so we
        // actually do not need to worry about that when our application is stopping.
        System.out.println("2-----You have " + (kit.wallet().getBalance()));
        System.out.println("2-----10 000 satoshi=	0.00010000 ฿ You have " + (kit.wallet().getBalance()) + "satoshi");
