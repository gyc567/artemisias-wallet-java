...
/**
 * ForwardingService demonstrates basic usage of the library. It sits on the
 * network and when it receives coins, simply sends them onwards to an address
...
public class ForwardingService {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (params == RegTestParams.get()) {
            ...
            // If you pick this mode, you're expected to be running a local "bitcoind
            // -regtest" instance.
        ...
        kit.wallet().addCoinsReceivedEventListener(new WalletCoinsReceivedEventListener() {
            ...
            public void onCoinsReceived(Wallet w, final Transaction tx, Coin prevBalance, Coin newBalance) {
                // Runs in the dedicated "user thread" (see bitcoinj docs for more info on
                // this).
                //
