 ...
 */
public class EthHDWalletWithWeb3j {
        private static final Logger log = LoggerFactory.getLogger(EthHDWalletWithWeb3j.class);
...

        {
                ...
                Web3j web3j = Web3j.build(new HttpService("https://rinkeby.infura.io/<your token>")); // FIXME: Enter
                                                                                                      // your
                                                                                                      // Infura token
                                                                                                      // here;
                ...
                TransactionReceipt transferReceipt = Transfer
                                .sendFunds(web3j, credentials, "0x19e03255f667bdfd50a32722df860b1eeaf4d635", // you can
                                                // put any
                                                // address
                                                // here
                ...
                // Greeter contract = Greeter.deploy(web3j, credentials, contractGasProvider,
                // "test").send();
                ...
                // TransactionReceipt transactionReceipt = contract.newGreeting("Well hello
                // again").send();
                ...
                // our
                // // smart
                // // contract to the blockchain. Index events cannot be logged in their
                // entirety.
                ...
                // Numeric.toHexString(event.oldGreetingIdx)
                // + ", new value: " + Numeric.toHexString(event.newGreetingIdx));
                // }
        }

        public static String createWallet() throws InvalidAlgorithmParameterException, NoSuchAlgorithmException,
